...
export function defaultRouteFor(role: Role, isSuperAdmin = false): string { if (isSuperAdmin) return "/super-admin"; if (role === "reader") return "/readings"; if (role === "cashier") return "/bills"; return "/"; }
