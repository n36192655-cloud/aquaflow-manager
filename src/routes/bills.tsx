...
import { Printer, Wallet, Droplets, Zap, Smartphone, ShieldCheck } from "lucide-react";
...
function BillsPage() {
  ...
  const filtered = bills.filter((b) => tab === "all" || b.status === tab || (tab === "unpaid" && b.status === "partial"));
                  ...
                  <TableRow key={b.id}>
                    ...
                    <TableCell>
                      <div className="flex gap-1">
                        ...
                        {b.status !== "paid" && (
                          <>
                            <Button size="sm" onClick={() => { setPayFor(b.id); setAmount(String(remaining)); setMethod("نقدي"); }}>
